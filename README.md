...
If you want to install the majority of those dependencies using Linux distribution packages (instead of PIP), you can do this:
    ...
    # On Fedora:
    sudo dnf install python3-nose python3-pyxdg python3-pyflakes python3-pep8 python3-pycodestyle python3-mock python3-dbus gobject-introspection python-liblarch
    
    # On Ubuntu/Debian:
    sudo apt install python3-nose python3-xdg python3-pyflakes python3-pep8 python3-pycodestyle python3-mock python3-dbus gobject-introspection python-liblarch
